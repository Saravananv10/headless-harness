# ExecutiveTravelAndExpenseReimb — Executive Travel & Expense Reimbursement Fraud Detector
...
## 1. Product identity
Build **ExecutiveTravelAndExpenseReimb** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that analyzes employee expense claims, identifying duplicate receipts, claims submitted during annual leave, and non-compliant expense categories.
