# SharedVendorEmployeeBankAccoun — Shared Vendor-Employee Bank Account & Address Linkage Detector
...
## 1. Product identity
Build **SharedVendorEmployeeBankAccoun** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python forensic analytics tool that cross-references vendor master data against employee payroll files, flagging shared bank accounts, addresses, or PANs.
