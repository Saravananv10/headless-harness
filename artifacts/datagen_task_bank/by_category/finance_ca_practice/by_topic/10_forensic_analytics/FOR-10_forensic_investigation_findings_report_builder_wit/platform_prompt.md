# ForensicInvestigationFindingsR — Forensic Investigation Findings Report Builder with Chain of Custody

## Complexity & fidelity lock (datagen)
- Task ID: **FOR-10**
- Category: **forensic_analytics**
...
## 1. Product identity
Build **ForensicInvestigationFindingsR** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that compiles forensic audit exception logs into a structured forensic investigation report with quantified financial exposure and evidence logs.
