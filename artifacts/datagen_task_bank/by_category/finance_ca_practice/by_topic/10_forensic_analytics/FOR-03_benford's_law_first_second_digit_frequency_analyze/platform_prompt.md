# Benford'sLawFirst/SecondDigitF — Benford's Law First/Second Digit Frequency Analyzer
...
## 1. Product identity
Build **Benford'sLawFirst/SecondDigitF** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python forensic script that applies Benford's Law digit distribution analysis to financial transaction populations, flagging anomalous digit frequencies.
