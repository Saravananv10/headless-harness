# KickbackAndConsultingFeePatter — Kickback & Consulting Fee Pattern Analyzer
...
## 1. Product identity
Build **KickbackAndConsultingFeePatter** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that flags rounded consulting/advisory fee payments lacking underlying deliverable attachments or approved contract agreements.
