# AssetStrippingAndInventoryDisc — Asset Stripping & Inventory Discrepancy Forensic Tool
...
## 1. Product identity
Build **AssetStrippingAndInventoryDisc** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python forensic tool to reconcile physical stock audit counts against inventory ledgers, flagging unexplained stock shrinkage and unauthorized scrap sales.
