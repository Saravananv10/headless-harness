# OffBalanceSheetAndHiddenLiabil — Off-Balance Sheet & Hidden Liability Flagger
...
## 1. Product identity
Build **OffBalanceSheetAndHiddenLiabil** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool to scan journal entries and contract logs for unrecorded corporate guarantees, letter of comfort liabilities, and off-balance sheet commitments.
