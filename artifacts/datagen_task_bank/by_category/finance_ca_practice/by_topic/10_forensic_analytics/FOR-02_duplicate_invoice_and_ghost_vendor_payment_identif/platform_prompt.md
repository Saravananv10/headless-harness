# DuplicateInvoiceAndGhostVendor — Duplicate Invoice & Ghost Vendor Payment Identifier
...
## 1. Product identity
Build **DuplicateInvoiceAndGhostVendor** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that scans accounts payable registers for duplicate invoice numbers, matching amounts across similar vendor names, and inactive vendor payouts.
