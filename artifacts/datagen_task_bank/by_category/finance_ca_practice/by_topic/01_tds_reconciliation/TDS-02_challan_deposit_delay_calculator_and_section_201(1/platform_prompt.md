# ChallanDepositDelayCalculatorA — Challan Deposit Delay Calculator & Section 201(1A) Interest Engine

## Complexity & fidelity lock (datagen)
- Task ID: **TDS-02**
- Category: **tds_reconciliation**
...
## 1. Product identity
Build **ChallanDepositDelayCalculatorA** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script to cross-reference TDS deduction dates against deposit dates in challan register, identify late deposits, and calculate Section 201(1A) interest liability at 1.5% per month.
