# QuarterlyForm26QReturnDataBuil — Quarterly Form 26Q Return Data Builder & Validation Engine
...
## 1. Product identity
Build **QuarterlyForm26QReturnDataBuil** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python utility that aggregates quarterly TDS registers, structures Form 26Q filing tables, validates BSR codes and challan numbers, and outputs filing-ready JSON.
