# LowerDeductionCertificate(Form — Lower Deduction Certificate (Form 13) Rate Validator
...
## 1. Product identity
Build **LowerDeductionCertificate(Form** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that ingests Form 13 lower/zero deduction certificates, validates certificate validity periods and thresholds against invoice dates, and flags over-deduction.
