# NonResidentRemittance(Section1 — Non-Resident Remittance (Section 195) & Form 15CA/15CB Audit Tool
...
## 1. Product identity
Build **NonResidentRemittance(Section1** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool to process foreign remittance transactions, verify DTAA tax rates, check Form 15CA/15CB filings, and calculate withholding tax exposure.
