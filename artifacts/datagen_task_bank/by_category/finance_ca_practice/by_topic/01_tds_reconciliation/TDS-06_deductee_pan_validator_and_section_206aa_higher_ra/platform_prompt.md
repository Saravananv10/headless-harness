# DeducteePANValidatorAndSection — Deductee PAN Validator & Section 206AA Higher Rate Audit
...
## 1. Product identity
Build **DeducteePANValidatorAndSection** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool to validate deductee PAN regex, identify invalid or inoperative PANs, and compute higher TDS deduction liability at 20% u/s 206AA.
