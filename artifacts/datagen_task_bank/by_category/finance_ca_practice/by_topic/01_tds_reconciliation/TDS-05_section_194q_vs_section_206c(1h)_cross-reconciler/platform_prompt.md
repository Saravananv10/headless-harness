# Section194QvsSection206C(1H)Cr — Section 194Q vs Section 206C(1H) Cross-Reconciler
...
## 1. Product identity
Build **Section194QvsSection206C(1H)Cr** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python reconciliation tool to compare buyer TDS u/s 194Q against seller TCS u/s 206C(1H) for transaction values exceeding INR 50 Lakhs and flag double deduction or missing tax.
