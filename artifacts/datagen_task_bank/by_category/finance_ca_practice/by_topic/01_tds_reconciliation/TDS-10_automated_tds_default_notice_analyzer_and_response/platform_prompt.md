# AutomatedTDSDefaultNoticeAnaly — Automated TDS Default Notice Analyzer & Response Drafter
...
## 1. Product identity
Build **AutomatedTDSDefaultNoticeAnaly** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool to ingest TRACES demand notices, parse short deduction/short payment lines, recalculate actual tax liability, and draft a response letter.
