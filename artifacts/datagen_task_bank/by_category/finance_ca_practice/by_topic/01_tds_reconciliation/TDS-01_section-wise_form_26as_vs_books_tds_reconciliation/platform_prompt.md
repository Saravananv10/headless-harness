# SectionwiseForm26ASvsBooksTDSR — Section-wise Form 26AS vs Books TDS Reconciliation
...
## 1. Product identity
Build **SectionwiseForm26ASvsBooksTDSR** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that ingests Form 26AS and Books TDS registers, matches entries by deductor TAN, section, and quarter, flags mismatches, and outputs a variance report.
