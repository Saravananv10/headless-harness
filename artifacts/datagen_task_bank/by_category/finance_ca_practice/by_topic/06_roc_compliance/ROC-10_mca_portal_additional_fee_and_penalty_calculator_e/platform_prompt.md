# MCAPortalAdditionalFeeAndPenal — MCA Portal Additional Fee & Penalty Calculator Engine
...
## 1. Product identity
Build **MCAPortalAdditionalFeeAndPenal** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that computes additional statutory filing fees (INR 100/day for delayed AOC-4/MGT-7) based on actual vs due filing dates and outputs penalty exposure reports.
