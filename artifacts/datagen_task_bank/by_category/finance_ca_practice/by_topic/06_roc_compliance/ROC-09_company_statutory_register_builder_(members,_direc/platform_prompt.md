# CompanyStatutoryRegisterBuilde — Company Statutory Register Builder (Members, Directors, Contracts)
...
## 1. Product identity
Build **CompanyStatutoryRegisterBuilde** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that generates digital statutory registers (Form MGT-1 Register of Members, Form MBP-2 Register of Loans/Guarantees) per Companies Act 2013 requirements.
