# MSMEOverduePaymentAndFormMSME1 — MSME Overdue Payment & Form MSME-1 Return Builder
...
## 1. Product identity
Build **MSMEOverduePaymentAndFormMSME1** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that analyzes AP aging, flags payments to MSME vendors exceeding statutory 45-day terms, calculates Section 16 interest penalty, and builds Form MSME-1 data.
