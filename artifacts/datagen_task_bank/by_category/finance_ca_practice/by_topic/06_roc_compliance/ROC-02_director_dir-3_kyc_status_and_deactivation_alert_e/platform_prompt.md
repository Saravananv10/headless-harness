# DirectorDIR3KYCStatusAndDeacti — Director DIR-3 KYC Status & Deactivation Alert Engine
...
## 1. Product identity
Build **DirectorDIR3KYCStatusAndDeacti** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool to validate Director Identification Numbers (DIN), verify annual DIR-3 KYC filing status, flag approaching deadlines, and alert management of potential DIN deactivation.
