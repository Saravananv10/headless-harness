# SignificantBeneficialOwnership — Significant Beneficial Ownership Audit Tool (Form SBO-1/2)
...
## 1. Product identity
Build **SignificantBeneficialOwnership** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python audit tool that parses shareholder registers, traces ultimate beneficial ownership (>10% interest/control), and identifies non-individual shareholders requiring SBO disclosures.
