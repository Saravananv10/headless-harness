# ChargeRegistrationAndSatisfact — Charge Registration & Satisfaction Timeline Tracker (Form CHG-1/4)
...
## 1. Product identity
Build **ChargeRegistrationAndSatisfact** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool to track bank loan sanction dates, calculate 30-day statutory windows for CHG-1 (creation) and CHG-4 (satisfaction), and compute late filing condonation fees.
