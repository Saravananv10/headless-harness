# EntityStatutoryFilingCalendarA — Entity Statutory Filing Calendar & Deadline Tracker
...
## 1. Product identity
Build **EntityStatutoryFilingCalendarA** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python compliance tool that maintains entity master data, tracks MCA filing deadlines (AOC-4, MGT-7, DIR-3 KYC, DPT-3), and generates compliance status reports.
