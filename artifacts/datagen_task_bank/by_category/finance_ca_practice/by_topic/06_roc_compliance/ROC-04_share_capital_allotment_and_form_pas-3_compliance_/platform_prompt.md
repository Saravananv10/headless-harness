# ShareCapitalAllotmentAndFormPA — Share Capital Allotment & Form PAS-3 Compliance Auditor
...
## 1. Product identity
Build **ShareCapitalAllotmentAndFormPA** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python script to verify private placement share allotment records, check valuation report dates, calculate stamp duty payable, and audit Form PAS-3 filing compliance.
