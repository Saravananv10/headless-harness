# Section185/186LoansAndInvestme — Section 185/186 Loans & Investment Limit Calculator
...
## 1. Product identity
Build **Section185/186LoansAndInvestme** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python compliance calculator to check total loans, guarantees, and investments against 60% of paid-up capital + reserves (Section 186), flagging special resolution requirements.
