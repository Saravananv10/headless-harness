# BoardMeetingAndAGMNotice,Agend — Board Meeting & AGM Notice, Agenda, and Resolution Generator
...
## 1. Product identity
Build **BoardMeetingAndAGMNotice,Agend** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that ingests meeting details, drafts statutory Board Meeting notices, agendas, and Board Resolutions (markdown templates) compliant with Secretarial Standards (SS-1).
