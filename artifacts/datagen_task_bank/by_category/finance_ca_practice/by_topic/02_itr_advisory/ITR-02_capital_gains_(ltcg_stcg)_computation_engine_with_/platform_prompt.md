# CapitalGains(LTCG/STCG)Computa — Capital Gains (LTCG/STCG) Computation Engine with Grandfathering
...
## 1. Product identity
Build **CapitalGains(LTCG/STCG)Computa** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool to process equity and mutual fund trade logs, apply Section 112A grandfathering rules (FMV as of 31-Jan-2018), compute LTCG/STCG tax, and draft Schedule CG.
