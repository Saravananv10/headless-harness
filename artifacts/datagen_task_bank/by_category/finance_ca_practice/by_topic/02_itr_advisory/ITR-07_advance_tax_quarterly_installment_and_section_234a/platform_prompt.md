# AdvanceTaxQuarterlyInstallment — Advance Tax Quarterly Installment & Section 234A/B/C Interest Auditor
...
## 1. Product identity
Build **AdvanceTaxQuarterlyInstallment** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool to calculate quarterly advance tax liability (15%, 45%, 75%, 100%), compare against actual tax paid, and compute Section 234B and 234C interest penalties.
