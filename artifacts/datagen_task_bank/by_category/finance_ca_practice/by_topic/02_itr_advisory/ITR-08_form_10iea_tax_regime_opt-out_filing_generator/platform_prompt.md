# Form10IEATaxRegimeOptOutFiling — Form 10IEA Tax Regime Opt-Out Filing Generator
...
## 1. Product identity
Build **Form10IEATaxRegimeOptOutFiling** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that generates Form 10IEA opt-out/opt-in filing payloads for business income assessee choosing old tax regime, validating filing due dates.
