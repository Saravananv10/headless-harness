# HousePropertyIncomeAndSection2 — House Property Income & Section 24 Interest Deduction Engine

## Complexity & fidelity lock (datagen)
- Task ID: **ITR-05**
- Category: **itr_advisory**
...
## 1. Product identity
Build **HousePropertyIncomeAndSection2** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python script that calculates Net Annual Value (NAV) for self-occupied and let-out properties, applies standard 30% deduction, and caps home loan interest deduction under Section 24(b).
