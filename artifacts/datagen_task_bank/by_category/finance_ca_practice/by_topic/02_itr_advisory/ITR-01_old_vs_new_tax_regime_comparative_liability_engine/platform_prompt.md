# OldvsNewTaxRegimeComparativeLi — Old vs New Tax Regime Comparative Liability Engine
...
## 1. Product identity
Build **OldvsNewTaxRegimeComparativeLi** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python calculator that ingests salary Form 16 and deduction proofs, computes tax liability under both Old (Section 115BAC) and New tax regimes, and outputs a recommendation memo.
