# ITR1toITR4JSONPayloadBuilderAn — ITR-1 to ITR-4 JSON Payload Builder & Schema Validator
...
## 1. Product identity
Build **ITR1toITR4JSONPayloadBuilderAn** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python validation tool that compiles client tax datasets into official CBDT ITR JSON schema format, verifying mandatory field constraints before upload.
