# Section80C/80D/80GDeductionPro — Section 80C/80D/80G Deduction Proof Audit Checker
...
## 1. Product identity
Build **Section80C/80D/80GDeductionPro** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python verification script that audits employee deduction proofs against statutory caps (80C 1.5L, 80D 25k/50k, 80G 50%/100%), flagging ineligible claims.
