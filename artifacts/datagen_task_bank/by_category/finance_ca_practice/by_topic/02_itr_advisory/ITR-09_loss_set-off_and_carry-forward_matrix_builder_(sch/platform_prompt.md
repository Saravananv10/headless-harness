# LossSetOffAndCarryForwardMatri — Loss Set-Off & Carry-Forward Matrix Builder (Schedule CFL)
...
## 1. Product identity
Build **LossSetOffAndCarryForwardMatri** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python engine that applies intra-head and inter-head loss set-off rules, tracks 8-year carry-forward limits for business/capital losses, and generates Schedule CFL.
