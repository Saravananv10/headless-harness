# ForeignAssetsAndIncomeDisclosu — Foreign Assets & Income Disclosure Auditor (Schedule FA)
...
## 1. Product identity
Build **ForeignAssetsAndIncomeDisclosu** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool to parse overseas bank statements, stock holdings, and foreign tax paid, generate Schedule FA disclosure tables for ITR-2/ITR-3, and calculate Section 90/91 DTAA relief.
