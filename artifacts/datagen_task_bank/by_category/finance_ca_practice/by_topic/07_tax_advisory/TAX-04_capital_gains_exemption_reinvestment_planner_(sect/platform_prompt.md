# CapitalGainsExemptionReinvestm — Capital Gains Exemption Reinvestment Planner (Section 54/54EC/54F)
...
## 1. Product identity
Build **CapitalGainsExemptionReinvestm** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that calculates capital gains tax savings achievable by investing in residential property (54/54F) or 54EC REC/NHAI bonds within statutory timelines.
