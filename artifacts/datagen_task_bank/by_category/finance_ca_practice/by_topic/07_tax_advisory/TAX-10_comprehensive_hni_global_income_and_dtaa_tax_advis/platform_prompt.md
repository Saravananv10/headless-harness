# ComprehensiveHNIGlobalIncomeAn — Comprehensive HNI Global Income & DTAA Tax Advisory Generator
...
## 1. Product identity
Build **ComprehensiveHNIGlobalIncomeAn** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python engine that models dual-resident HNI tax profiles, applies DTAA tie-breaker rules and foreign tax credit (FTC) limits, and outputs a client tax advisory report.
