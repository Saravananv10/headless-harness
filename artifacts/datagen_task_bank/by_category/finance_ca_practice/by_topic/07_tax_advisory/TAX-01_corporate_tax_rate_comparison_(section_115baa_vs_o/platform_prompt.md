# CorporateTaxRateComparison(Sec — Corporate Tax Rate Comparison (Section 115BAA vs Old Regime)
...
## 1. Product identity
Build **CorporateTaxRateComparison(Sec** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that summarizes tax provisions, analyzes multiple structuring options, computes tax at 22% (115BAA) vs 30% (Old) with MAT credit, and drafts an advisory memo.
