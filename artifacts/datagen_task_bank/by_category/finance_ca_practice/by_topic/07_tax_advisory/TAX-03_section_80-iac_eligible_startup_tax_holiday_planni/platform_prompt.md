# Section80IACEligibleStartupTax — Section 80-IAC Eligible Startup Tax Holiday Planning Tool
...
## 1. Product identity
Build **Section80IACEligibleStartupTax** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool to check DPIIT recognition, turnover limits (100 Cr), and incorporation dates for Section 80-IAC eligibility, modeling optimal 3 consecutive tax exemption years.
