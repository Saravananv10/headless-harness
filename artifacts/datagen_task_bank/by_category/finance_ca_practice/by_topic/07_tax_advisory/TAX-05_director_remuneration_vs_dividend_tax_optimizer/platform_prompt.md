# DirectorRemunerationvsDividend — Director Remuneration vs Dividend Tax Optimizer
...
## 1. Product identity
Build **DirectorRemunerationvsDividend** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python model to determine the optimal split between Director Salary (deductible for co., taxable for individual) and Dividend Distribution to minimize total tax payout.
