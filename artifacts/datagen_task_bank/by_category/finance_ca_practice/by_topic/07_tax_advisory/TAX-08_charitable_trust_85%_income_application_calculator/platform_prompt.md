# CharitableTrust85%IncomeApplic — Charitable Trust 85% Income Application Calculator (Form 10B/10BB)
...
## 1. Product identity
Build **CharitableTrust85%IncomeApplic** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool for Section 11 trusts that calculates total income, checks 85% charitable application mandate, computes Form 10 accumulation, and models tax liability.
