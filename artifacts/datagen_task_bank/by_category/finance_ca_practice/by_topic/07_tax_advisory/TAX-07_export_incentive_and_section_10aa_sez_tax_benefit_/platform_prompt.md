# ExportIncentiveAndSection10AAS — Export Incentive & Section 10AA SEZ Tax Benefit Planner
...
## 1. Product identity
Build **ExportIncentiveAndSection10AAS** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool to calculate Section 10AA tax deductions for SEZ units (100% first 5 yrs, 50% next 5 yrs), verifying export turnover ratios against total turnover.
