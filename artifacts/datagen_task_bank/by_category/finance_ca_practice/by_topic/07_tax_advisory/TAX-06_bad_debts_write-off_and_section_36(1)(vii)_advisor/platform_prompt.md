# BadDebtsWriteoffAndSection36(1 — Bad Debts Write-off & Section 36(1)(vii) Advisory Tool
...
## 1. Product identity
Build **BadDebtsWriteoffAndSection36(1** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script to audit aged receivables, check Section 36(2) previous income inclusion compliance, and draft bad debt write-off advisory notes.
