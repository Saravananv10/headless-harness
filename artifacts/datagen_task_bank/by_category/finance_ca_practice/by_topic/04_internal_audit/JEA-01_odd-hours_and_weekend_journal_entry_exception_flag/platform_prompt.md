# OddHoursAndWeekendJournalEntry — Odd-Hours & Weekend Journal Entry Exception Flagger
...
## 1. Product identity
Build **OddHoursAndWeekendJournalEntry** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python internal audit script to scan journal entry timestamps, flag entries posted between 10 PM and 5 AM or on weekends, and score user exposure risk.
