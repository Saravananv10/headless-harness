# RoundSumAndThresholdEvasionJou — Round-Sum & Threshold Evasion Journal Entry Detector
...
## 1. Product identity
Build **RoundSumAndThresholdEvasionJou** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool to identify round-number journal entries (e.g., exactly 50,000 or 1,000,000) and entries posted just below approval authorization limits.
