# PeriodEndClosingEntrySpikeAndR — Period-End Closing Entry Spike & Reversal Analyzer
...
## 1. Product identity
Build **PeriodEndClosingEntrySpikeAndR** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that analyzes journal entry volume and value distributions during the last 3 days of the month, flagging post-close manual adjustments and immediate reversals.
