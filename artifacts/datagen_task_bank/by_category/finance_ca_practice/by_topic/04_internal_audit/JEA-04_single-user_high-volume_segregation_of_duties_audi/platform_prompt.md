# SingleUserHighVolumeSegregatio — Single-User High-Volume Segregation of Duties Audit
...
## 1. Product identity
Build **SingleUserHighVolumeSegregatio** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that analyzes user posting logs, flags users who both create and approve high-value manual journal entries, and outputs an SoD violation report.
