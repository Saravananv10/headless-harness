# RevenueCutoffAndBackdatedInvoi — Revenue Cut-off & Backdated Invoice Journal Tester
...
## 1. Product identity
Build **RevenueCutoffAndBackdatedInvoi** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that compares invoice dates against shipping/service fulfillment dates and journal posting dates, flagging revenue recognized prematurely.
