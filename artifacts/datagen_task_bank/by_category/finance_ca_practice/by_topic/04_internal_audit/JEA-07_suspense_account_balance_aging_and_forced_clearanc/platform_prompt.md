# SuspenseAccountBalanceAgingAnd — Suspense Account Balance Aging & Forced Clearance Audit
...
## 1. Product identity
Build **SuspenseAccountBalanceAgingAnd** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that tracks suspense and clearing account entries, calculates balance aging, and flags entries remaining uncleared past 30 days.
