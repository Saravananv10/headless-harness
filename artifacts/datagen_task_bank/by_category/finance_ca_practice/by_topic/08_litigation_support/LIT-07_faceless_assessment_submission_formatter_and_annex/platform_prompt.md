# FacelessAssessmentSubmissionFo — Faceless Assessment Submission Formatter & Annexure Indexer
...
## 1. Product identity
Build **FacelessAssessmentSubmissionFo** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that compiles written submissions for Faceless Assessment portals, formats hyperlinked document indexes, and verifies file attachment size limits.
