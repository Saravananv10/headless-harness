# StatutoryLimitationPeriodTrack — Statutory Limitation Period Tracker for Appeals & Notices
...
## 1. Product identity
Build **StatutoryLimitationPeriodTrack** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that tracks service dates of tax orders, computes statutory deadline dates (30 days for CIT(A), 60 days for ITAT), and flags approaching limitation cut-offs.
