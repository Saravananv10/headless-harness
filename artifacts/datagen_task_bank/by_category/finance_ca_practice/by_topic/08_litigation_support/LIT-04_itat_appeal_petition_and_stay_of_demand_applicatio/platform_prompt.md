# ITATAppealPetitionAndStayofDem — ITAT Appeal Petition & Stay of Demand Application Drafter
...
## 1. Product identity
Build **ITATAppealPetitionAndStayofDem** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python legal drafting tool to format ITAT appeal memos, prepare stay of demand applications demonstrating financial hardship, and draft stay petition affidavits.
