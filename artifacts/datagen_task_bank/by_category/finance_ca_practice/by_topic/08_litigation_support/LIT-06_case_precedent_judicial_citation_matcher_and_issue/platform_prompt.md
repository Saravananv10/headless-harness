# CasePrecedentJudicialCitationM — Case Precedent Judicial Citation Matcher & Issue Framing Tool
...
## 1. Product identity
Build **CasePrecedentJudicialCitationM** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that matches notice issue keywords against a local database of Supreme Court and High Court tax judgments, inserting relevant legal citations into reply drafts.
