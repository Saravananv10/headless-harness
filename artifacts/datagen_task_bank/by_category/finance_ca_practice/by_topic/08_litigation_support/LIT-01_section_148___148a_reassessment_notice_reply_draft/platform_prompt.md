# Section148/148AReassessmentNot — Section 148 / 148A Reassessment Notice Reply Drafter
...
## 1. Product identity
Build **Section148/148AReassessmentNot** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool that ingests assessment orders and show-cause notices, summarizes key issues, drafts legal replies with section citations, and tracks statutory deadlines.
