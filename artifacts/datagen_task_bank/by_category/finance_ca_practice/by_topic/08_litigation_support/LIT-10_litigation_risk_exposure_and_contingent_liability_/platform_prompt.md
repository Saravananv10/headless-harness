# LitigationRiskExposureAndConti — Litigation Risk Exposure & Contingent Liability Quantifier
...
## 1. Product identity
Build **LitigationRiskExposureAndConti** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that aggregates pending tax litigation cases across forums (CIT(A), ITAT, High Court), computes total financial exposure, and calculates AS 29 contingent liability disclosures.
