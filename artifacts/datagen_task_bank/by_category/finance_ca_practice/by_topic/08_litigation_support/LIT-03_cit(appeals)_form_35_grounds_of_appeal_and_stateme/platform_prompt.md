# CIT(Appeals)Form35GroundsofApp — CIT(Appeals) Form 35 Grounds of Appeal & Statement of Facts Drafter
...
## 1. Product identity
Build **CIT(Appeals)Form35GroundsofApp** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that ingests assessment order additions, structures concise Grounds of Appeal and Statement of Facts, and builds draft Form 35 appeal documents.
