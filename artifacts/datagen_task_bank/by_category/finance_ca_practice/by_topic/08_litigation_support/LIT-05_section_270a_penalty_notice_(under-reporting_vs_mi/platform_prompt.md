# Section270APenaltyNotice(Under — Section 270A Penalty Notice (Under-reporting vs Misreporting) Analyzer
...
## 1. Product identity
Build **Section270APenaltyNotice(Under** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool to parse Section 270A penalty show-cause notices, analyze whether additions fall under 50% under-reporting or 200% misreporting, and draft legal objections.
