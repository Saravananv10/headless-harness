# PreliminaryAnalyticalReviewAnd — Preliminary Analytical Review & YoY Variance Analyzer
...
## 1. Product identity
Build **PreliminaryAnalyticalReviewAnd** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that ingests current and prior year trial balance CSVs, calculates percentage and absolute variances, and highlights accounts exceeding risk thresholds.
