# SA315RiskAssessmentMatrixAndCo — SA 315 Risk Assessment Matrix & Control Risk Profiler
...
## 1. Product identity
Build **SA315RiskAssessmentMatrixAndCo** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python risk profiler that evaluates financial statement risk areas (Revenue Cut-off, Valuation, Related Parties), scores inherent and control risk, and drafts a risk matrix.
