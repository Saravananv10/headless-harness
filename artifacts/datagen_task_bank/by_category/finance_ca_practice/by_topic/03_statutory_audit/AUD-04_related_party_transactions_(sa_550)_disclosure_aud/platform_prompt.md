# RelatedPartyTransactions(SA550 — Related Party Transactions (SA 550) Disclosure Auditor
...
## 1. Product identity
Build **RelatedPartyTransactions(SA550** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool to cross-reference general ledger transactions against director and key management personnel (KMP) lists, flagging undisclosed related party deals.
