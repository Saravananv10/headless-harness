# StatutoryAuditMasterProgramAnd — Statutory Audit Master Program & Test Procedure Generator
...
## 1. Product identity
Build **StatutoryAuditMasterProgramAnd** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that compiles account-wise audit procedures, maps assertions (Completeness, Existence, Accuracy), and outputs an interactive audit execution checklist.
