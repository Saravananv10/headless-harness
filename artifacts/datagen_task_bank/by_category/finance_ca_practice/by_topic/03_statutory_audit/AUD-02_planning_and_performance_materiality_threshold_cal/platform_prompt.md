# PlanningAndPerformanceMaterial — Planning & Performance Materiality Threshold Calculator (SA 320)
...
## 1. Product identity
Build **PlanningAndPerformanceMaterial** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that calculates Overall Materiality, Performance Materiality, and Trivial Thresholds using benchmark percentages (Revenue, Gross Profit, Total Assets).
