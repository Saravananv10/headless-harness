# SubsequentEvents(SA560)LedgerA — Subsequent Events (SA 560) Ledger Auditor & Adjustment Tracker
...
## 1. Product identity
Build **SubsequentEvents(SA560)LedgerA** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool to scan general ledger transactions post-financial-year-end, flag adjusting vs non-adjusting events, and generate SA 560 audit workpapers.
