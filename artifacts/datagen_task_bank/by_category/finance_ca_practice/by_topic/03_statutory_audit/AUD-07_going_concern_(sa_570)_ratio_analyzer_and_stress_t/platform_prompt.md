# GoingConcern(SA570)RatioAnalyz — Going Concern (SA 570) Ratio Analyzer & Stress Tester
...
## 1. Product identity
Build **GoingConcern(SA570)RatioAnalyz** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool to calculate liquidity ratios (Current, Quick, Debt-Service Coverage), test cash runway under negative scenarios, and generate SA 570 going concern assessment memo.
