# InventoryValuationAndSlowMovin — Inventory Valuation & Slow-Moving Provision Tester (AS 2)
...
## 1. Product identity
Build **InventoryValuationAndSlowMovin** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python script that analyzes stock movement logs, calculates inventory turnover days, identifies slow-moving/obsolete stock, and tests NRV provisioning adequacy.
