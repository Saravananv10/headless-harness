# MonthEndAccrualsAndPrepaidAmor — Month-End Accruals & Prepaid Amortization Schedule Builder
...
## 1. Product identity
Build **MonthEndAccrualsAndPrepaidAmor** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool to process recurring expense contracts, build monthly prepaid amortization schedules, calculate accrued expenses, and post month-end close journals.
