# InterCompanyLedgerMatchingAndD — Inter-Company Ledger Matching & Discrepancy Flagger
...
## 1. Product identity
Build **InterCompanyLedgerMatchingAndD** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that reconciles mirror ledgers across parent and subsidiary entities, identifying un-recorded inter-company transfers and timing mismatches.
