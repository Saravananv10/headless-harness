# BankChargesAndDirectInterestAu — Bank Charges & Direct Interest Auto-Posting Engine
...
## 1. Product identity
Build **BankChargesAndDirectInterestAu** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python script that parses bank statements for unrecorded bank charges, interest credits, and auto-debits, generating ready-to-post month-end journal entries.
