# UnenteredCustomerDirectDeposit — Un-entered Customer Direct Deposit Matcher & Tagger
...
## 1. Product identity
Build **UnenteredCustomerDirectDeposit** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script to match un-identified incoming electronic credits against open customer invoices using remitter name fuzzy matching and transaction amounts.
