# FixedDepositInterestAccrualvsF — Fixed Deposit Interest Accrual vs Form 26AS Interest Cross-Reconciler
...
## 1. Product identity
Build **FixedDepositInterestAccrualvsF** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool to calculate FD interest accruals from bank deposit advice certificates, compare against Form 26AS interest income entries, and flag unrecorded income.
