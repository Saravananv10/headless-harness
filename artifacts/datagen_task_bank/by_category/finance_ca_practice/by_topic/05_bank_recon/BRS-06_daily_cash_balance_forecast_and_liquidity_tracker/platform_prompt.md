# DailyCashBalanceForecastAndLiq — Daily Cash Balance Forecast & Liquidity Tracker
...
## 1. Product identity
Build **DailyCashBalanceForecastAndLiq** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python dashboard tool that combines bank balance data, expected customer collections, and scheduled vendor payments to forecast daily cash liquidity for 30 days.
