# StaleCheque(3+Months)Identifie — Stale Cheque (3+ Months) Identifier & Reversal Advisor
...
## 1. Product identity
Build **StaleCheque(3+Months)Identifie** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool that scans uncleared cheques in bank reconciliations, identifies items outstanding over 90 days, and drafts write-back adjustment journal entries.
