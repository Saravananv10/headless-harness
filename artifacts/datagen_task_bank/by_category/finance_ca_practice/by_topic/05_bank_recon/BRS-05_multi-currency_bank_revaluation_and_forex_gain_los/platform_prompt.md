# MultiCurrencyBankRevaluationAn — Multi-Currency Bank Revaluation & Forex Gain/Loss Engine (AS 11)
...
## 1. Product identity
Build **MultiCurrencyBankRevaluationAn** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that ingests foreign currency bank balances and exchange rate tables, calculates unrealized forex gain/loss per AS 11 / Ind AS 21, and drafts revaluation entries.
