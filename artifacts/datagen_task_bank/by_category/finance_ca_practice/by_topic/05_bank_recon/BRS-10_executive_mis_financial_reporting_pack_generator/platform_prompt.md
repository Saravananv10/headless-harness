# ExecutiveMISFinancialReporting — Executive MIS Financial Reporting Pack Generator
...
## 1. Product identity
Build **ExecutiveMISFinancialReporting** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script using openpyxl that compiles monthly Trial Balance, P&L, Balance Sheet, and BRS into a formatted MIS Excel workbook with budget variance charts.
