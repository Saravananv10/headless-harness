# BankReconciliationStepbyStepIn — Bank Reconciliation Step-by-Step Interactive Tutorial Builder
...
## 1. Product identity
Build **BankReconciliationStepbyStepIn** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that generates step-by-step Bank Reconciliation tutorial exercises with sample ledger data and automated answer checking for new staff.
