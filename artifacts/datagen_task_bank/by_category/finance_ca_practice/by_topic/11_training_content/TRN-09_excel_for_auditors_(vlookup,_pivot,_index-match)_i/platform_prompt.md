# ExcelforAuditors(VLOOKUP,Pivot — Excel for Auditors (VLOOKUP, Pivot, INDEX-MATCH) Interactive Quiz
...
## 1. Product identity
Build **ExcelforAuditors(VLOOKUP,Pivot** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python script that generates Excel audit dataset challenges requiring trainees to apply formulas and pivot tables to discover deliberate data errors.
