# GSTInputTaxCredit(ITC)Eligibil — GST Input Tax Credit (ITC) Eligibility Flashcard & Quiz Builder
...
## 1. Product identity
Build **GSTInputTaxCredit(ITC)Eligibil** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that compiles Section 17(5) blocked credit rules into interactive scenario-based quiz questions with detailed legal explanations.
