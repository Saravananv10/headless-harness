# AuditSamplingMethodologyPracti — Audit Sampling Methodology Practical Case Study Builder
...
## 1. Product identity
Build **AuditSamplingMethodologyPracti** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python training tool that simulates general ledger populations and guides article assistants through sample size calculation and evaluation under SA 530.
