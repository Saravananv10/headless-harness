# TDSSectionAndRateCaseStudyAndQ — TDS Section & Rate Case Study & Quiz Generator
...
## 1. Product identity
Build **TDSSectionAndRateCaseStudyAndQ** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that generates practice questions and case studies from engagement data, explains standards and sections in plain language, and creates quizzes.
