# FinancialRatioAnalysisAndInter — Financial Ratio Analysis & Interpretation Assessment Builder
...
## 1. Product identity
Build **FinancialRatioAnalysisAndInter** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python assessment tool that generates company financial statements and tests trainees on calculating and interpreting liquidity, solvency, and profitability ratios.
