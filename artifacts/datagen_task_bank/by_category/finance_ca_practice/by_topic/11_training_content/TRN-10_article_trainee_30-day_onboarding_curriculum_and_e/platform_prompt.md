# ArticleTrainee30DayOnboardingC — Article Trainee 30-Day Onboarding Curriculum & Evaluation Matrix
...
## 1. Product identity
Build **ArticleTrainee30DayOnboardingC** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python tool that compiles a structured 30-day CA firm onboarding plan, tracks weekly assignment scores, and outputs a trainee readiness evaluation report.
