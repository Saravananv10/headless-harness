# ClientOnboardingRiskAssessment — Client Onboarding Risk Assessment & KYC Compliance Checker
...
## 1. Product identity
Build **ClientOnboardingRiskAssessment** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python onboarding tool that evaluates prospective client risk profiles (Anti-Money Laundering checks, promoter background verification) and generates KYC sign-off sheets.
