# ExecutivePracticeMISPerformanc — Executive Practice MIS Performance Dashboard
...
## 1. Product identity
Build **ExecutivePracticeMISPerformanc** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python dashboard tool using openpyxl/pandas that compiles partner-wise revenue, billing realization ratios, outstanding AR aging, and firm growth metrics.
