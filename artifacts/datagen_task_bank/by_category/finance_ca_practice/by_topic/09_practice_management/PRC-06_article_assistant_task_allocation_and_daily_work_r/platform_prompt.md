# ArticleAssistantTaskAllocation — Article Assistant Task Allocation & Daily Work Report Analyzer
...
## 1. Product identity
Build **ArticleAssistantTaskAllocation** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python script that parses daily work logs of article trainees, evaluates task completion rates, and generates allocation charts for upcoming deadlines.
