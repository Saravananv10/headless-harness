# FirmPrecedentAuditWorkpaperRep — Firm Precedent Audit Workpaper Repository Indexer
...
## 1. Product identity
Build **FirmPrecedentAuditWorkpaperRep** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool to scan and index past firm audit reports, tax opinions, and working papers, allowing fast keyword search for new engagement teams.
