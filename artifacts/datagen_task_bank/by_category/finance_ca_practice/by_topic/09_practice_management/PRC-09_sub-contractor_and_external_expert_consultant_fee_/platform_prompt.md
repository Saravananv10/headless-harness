# SubcontractorAndExternalExpert — Sub-contractor & External Expert Consultant Fee Tracker
...
## 1. Product identity
Build **SubcontractorAndExternalExpert** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool to manage external valuer/advocate engagement agreements, track deliverable milestones, and audit consultant invoice disbursements.
