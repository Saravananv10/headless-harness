# TimesheetLogtoClientBillingNar — Time-sheet Log to Client Billing Narrative & Profitability Analyzer
...
## 1. Product identity
Build **TimesheetLogtoClientBillingNar** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python script that aggregates staff time-sheet logs, calculates job profitability against fixed audit fees, and generates itemized billing narratives.
