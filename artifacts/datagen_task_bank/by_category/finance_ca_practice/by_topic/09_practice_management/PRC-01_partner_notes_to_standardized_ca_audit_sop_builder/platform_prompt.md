# PartnerNotestoStandardizedCAAu — Partner Notes to Standardized CA Audit SOP Builder
...
## 1. Product identity
Build **PartnerNotestoStandardizedCAAu** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Build a Python tool that converts unstructured partner meeting notes into structured Standard Operating Procedures (SOPs), engagement checklists, and task templates.
