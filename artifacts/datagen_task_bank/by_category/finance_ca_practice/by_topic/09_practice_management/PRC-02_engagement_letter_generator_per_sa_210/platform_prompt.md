# EngagementLetterGeneratorperSA — Engagement Letter Generator per SA 210
...
## 1. Product identity
Build **EngagementLetterGeneratorperSA** for category `finance_ca_practice`. Seed intent (honor this product, do not genericize away):

> Create a Python drafting tool that ingests client entity details and service scope, generating customized Statutory Audit engagement letters compliant with SA 210.
