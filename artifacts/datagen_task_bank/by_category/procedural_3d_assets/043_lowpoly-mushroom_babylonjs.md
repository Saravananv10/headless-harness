...
ASSET TO BUILD:
Stylized low-poly mushroom

Build a mushroom from a hemispherical (or flattened-dome) cap mesh seated atop a tapered cylindrical stem. Cap radius/flatness, stem height/radius, and mesh resolution must be CLI-configurable.
