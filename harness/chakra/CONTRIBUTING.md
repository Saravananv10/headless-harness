...
Chakra is a fast-moving open-source coding-agent CLI with support for multiple providers, local backends, MCP, and a terminal-first workflow. The best contributions here are focused, well-tested, and easy to review.

## Before You Start

- Search existing [issues](https://github.com/Gitlawb/chakra/issues) and [discussions](https://github.com/Gitlawb/chakra/discussions) before opening a new thread.
...
Chakra supports multiple provider paths. If you change provider logic:
