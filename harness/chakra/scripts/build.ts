/**
 * Chakra build script — bundles the TypeScript source into a single
...
const result = await Bun.build({
  ...
  define: {
    ...
    'MACRO.ISSUES_EXPLAINER':
      JSON.stringify('report the issue at https://github.com/soketlabs/chakra/issues'),
    'MACRO.PACKAGE_URL': JSON.stringify('@soketlabs/chakra'),
...
console.log(`✓ Built chakra v${version} → dist/cli.mjs`)
