...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/chakra.proto')
...
async function main() {
  ...
  const client = new chakraProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mChakra gRPC CLI\x1b[0m')
