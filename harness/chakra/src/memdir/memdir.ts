 ...
 * Constrains memories to a closed four-type taxonomy (user / guidance / project /
...
export function buildMemoryLines(
  ...
  const howToSave = skipIndex
    ? [
        ...
        '',
        'Write each memory to its own file (e.g., `user_role.md`, `guidance_testing.md`) using this frontmatter format:',
        '',
        ...MEMORY_FRONTMATTER_EXAMPLE,
        '',
    ...
    : [
        ...
        '',
        '**Step 1** — write the memory to its own file (e.g., `user_role.md`, `guidance_testing.md`) using this frontmatter format:',
        '',
        ...MEMORY_FRONTMATTER_EXAMPLE,
        '',
