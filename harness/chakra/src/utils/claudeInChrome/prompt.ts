export const BASE_CHROME_PROMPT = `# Browser automation in Chrome
 ...
 */
export const CLAUDE_IN_CHROME_SKILL_HINT = `**Browser Automation**: Chrome browser tools are available via the "browser-automation" skill. CRITICAL: Before using any mcp__browser-automation__* tools, invoke the skill by calling the Skill tool with skill: "browser-automation". The skill provides browser automation instructions and enables the tools.`
 ...
 */
export const CLAUDE_IN_CHROME_SKILL_HINT_WITH_WEBBROWSER = `**Browser Automation**: Use WebBrowser for development (dev servers, JS eval, console, screenshots). Use browser-automation for the user's real Chrome when you need logged-in sessions, OAuth, or computer-use — invoke Skill(skill: "browser-automation") before any mcp__browser-automation__* tool.`
