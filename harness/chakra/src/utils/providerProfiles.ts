  ...
  switch (preset) {
    ...
    case 'soket':
      return {
        provider: 'openai',
        name: 'Soket',
        baseUrl: 'https://api.model.soket.ai/v1',
        model: 'vidura-v1',
        apiKey: '',
...
function hasProviderSelectionFlags(
  ...
  return (
    ...
    processEnv.CLAUDE_CODE_USE_FIRST_PARTY !== undefined
  )
}
...
export function clearProviderProfileEnvFromProcessEnv(
  ...
  delete processEnv.CLAUDE_CODE_USE_SOKET
  delete processEnv.CLAUDE_CODE_USE_FIRST_PARTY
