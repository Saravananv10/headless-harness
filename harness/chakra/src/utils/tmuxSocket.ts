 ...
 * =====================
 * This module manages an isolated tmux socket for Chakra's operations.
 *
 * WHY THIS EXISTS:
 ...
 * directly or via Bash - will operate on Chakra's isolated socket, NOT the
 * user's tmux session.
 *
...
/**
 * Gets the socket name for Chakra's isolated tmux session.
 * Format: claude-<PID>
 */
...
/**
 * Gets the TMUX environment variable value for Chakra's isolated socket.
 *
 ...
 * the Bash tool will operate on Chakra's socket, NOT the user's session.
 *
...
/**
 * Kills the tmux server for Chakra's isolated socket.
...
async function doInitialize(): Promise<void> {
  ...
  // Any Chakra instance spawned on this socket will inherit this env var,
