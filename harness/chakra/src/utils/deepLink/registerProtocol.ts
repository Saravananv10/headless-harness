...
const APP_NAME = 'Chakra URL Handler'
const DESKTOP_FILE_NAME = 'claude-code-url-handler.desktop'
const MACOS_APP_NAME = 'Chakra URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Chakra Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Chakra
