/**
 * Chakra hints protocol.
 *
 * CLIs and SDKs running under Chakra can emit a self-closing
 * `<chakra-hint />` tag to stderr (merged into stdout by the shell
 ...
 *
 * See docs/chakra-hints.md for the vendor-facing spec.
 */
