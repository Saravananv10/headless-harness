...
export const PROFILE_FILE_NAME = '.chakra-profile.json'
export const DEFAULT_GEMINI_BASE_URL =
  'https://generativelanguage.googleapis.com/v1beta/openai'
export const DEFAULT_GEMINI_MODEL = 'gemini-2.0-flash'
export const DEFAULT_SOKET_BASE_URL = 'https://api.model.soket.ai/v1'
export const DEFAULT_SOKET_MODEL = 'vidura-v1'
...
export type ProviderProfile = 'openai' | 'ollama' | 'codex' | 'gemini' | 'atomic-chat' | 'soket'
...
export function buildSoketProfileEnv(options: {
  model?: string | null
  baseUrl?: string | null
...
export function hasExplicitProviderSelection(
  ...
  return (
    ...
    processEnv.CLAUDE_CODE_USE_SOKET !== undefined
  )
}
...
export function selectAutoProfile(
  ...
  return recommendedOllamaModel ? 'ollama' : 'soket'
}
...
export async function buildLaunchEnv(options: {
  ...
  if (options.profile === 'soket') {
    env.OPENAI_BASE_URL = persistedEnv.OPENAI_BASE_URL || DEFAULT_SOKET_BASE_URL
    env.OPENAI_MODEL = persistedEnv.OPENAI_MODEL || DEFAULT_SOKET_MODEL
