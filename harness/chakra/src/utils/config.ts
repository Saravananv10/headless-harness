...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Chakra was first started on this machine
  ...
  // Chakra usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Chakra OAuth token
  ...
  // Chakra hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
