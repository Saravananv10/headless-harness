...
function checkPathConstraintsForStatement(
  ...
  // Runtime writes /project/.claude/settings.json (Chakra's permission config).
  //
      ...
      if (!allowed) {
        ...
        const message =
          ...
          decisionReason?.type === 'safetyCheck'
            ...
            : `${canonical} targeting '${resolvedPath}' was blocked. For security, Chakra may only access files in the allowed working directories for this session: ${dirListStr}.`
