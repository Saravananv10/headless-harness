...
export const DESCRIPTION = 'Get or set Chakra configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Chakra configuration settings.

  View or change Chakra settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
