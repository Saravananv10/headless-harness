...
export function createWhatsNewFeed(releaseNotes: string[]): FeedConfig {
  ...
  return {
    title: "external" === 'ant' ? "Chakra Updates [internal-only: Latest CC commits]" : "Chakra Updates",
    lines,
...
export function createGuestPassesFeed(): FeedConfig {
  ...
  const subtitle = reward ? `Share Chakra and earn ${formatCreditAmount(reward)} of extra usage` : 'Share Chakra with friends';
  return {
