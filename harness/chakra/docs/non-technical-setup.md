# Chakra for Non-Technical Users
...
Chakra lets you use an AI coding assistant with different model providers such as:
...
After you run `chakra`, the CLI should start and wait for your prompt.
